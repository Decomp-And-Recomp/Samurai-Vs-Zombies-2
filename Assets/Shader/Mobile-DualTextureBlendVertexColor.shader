ȠShader "Mobile/Dual Texture Blend + Vertex Color" {
Properties {
...
void main ()
{
  lowp vec4 c_1;
  lowp vec3 tmpvar_2;
  tmpvar_2 = (((texture2D (_MainTex, xlv_TEXCOORD0) * xlv_COLOR0.w) + (texture2D (_BlendTex1, xlv_TEXCOORD0) * (1.00000 - xlv_COLOR0.w))) * xlv_COLOR0).xyz;
  lowp vec4 c_3;
  c_3.xyz = ((tmpvar_2 * _LightColor0.xyz) * (max (0.00000, dot (xlv_TEXCOORD1, _WorldSpaceLightPos0.xyz)) * 2.00000));
  c_3.w = 0.00000;
  c_1.w = c_3.w;
...
{
  lowp vec4 c_1;
  c_1.xyz = ((((texture2D (_MainTex, xlv_TEXCOORD0) * xlv_COLOR0.w) + (texture2D (_BlendTex1, xlv_TEXCOORD0) * (1.00000 - xlv_COLOR0.w))) * xlv_COLOR0).xyz * (2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz));
  c_1.w = 0.00000;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_3 = tmpvar_8;
  lowp vec4 c_9;
  c_9.xyz = ((tmpvar_2 * _LightColor0.xyz) * ((max (0.00000, dot (xlv_TEXCOORD1, _WorldSpaceLightPos0.xyz)) * tmpvar_3) * 2.00000));
  c_9.w = 0.00000;
  c_1.w = c_9.w;
...
void main ()
{
  ...
  tmpvar_2 = tmpvar_7;
  c_1.xyz = ((((texture2D (_MainTex, xlv_TEXCOORD0) * xlv_COLOR0.w) + (texture2D (_BlendTex1, xlv_TEXCOORD0) * (1.00000 - xlv_COLOR0.w))) * xlv_COLOR0).xyz * min ((2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((tmpvar_2 * 2.00000))));
  c_1.w = 0.00000;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  lowp vec4 c_5;
  c_5.xyz = (((((texture2D (_MainTex, xlv_TEXCOORD0) * xlv_COLOR0.w) + (texture2D (_BlendTex1, xlv_TEXCOORD0) * (1.00000 - xlv_COLOR0.w))) * xlv_COLOR0).xyz * _LightColor0.xyz) * ((max (0.00000, dot (xlv_TEXCOORD1, lightDir_2)) * texture2D (_LightTexture0, vec2(tmpvar_4)).w) * 2.00000));
  c_5.w = 0.00000;
  c_1.xyz = c_5.xyz;
  c_1.w = 0.00000;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec4 c_3;
  c_3.xyz = (((((texture2D (_MainTex, xlv_TEXCOORD0) * xlv_COLOR0.w) + (texture2D (_BlendTex1, xlv_TEXCOORD0) * (1.00000 - xlv_COLOR0.w))) * xlv_COLOR0).xyz * _LightColor0.xyz) * (max (0.00000, dot (xlv_TEXCOORD1, lightDir_2)) * 2.00000));
  c_3.w = 0.00000;
  c_1.xyz = c_3.xyz;
  c_1.w = 0.00000;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec4 c_7;
  c_7.xyz = (((((texture2D (_MainTex, xlv_TEXCOORD0) * xlv_COLOR0.w) + (texture2D (_BlendTex1, xlv_TEXCOORD0) * (1.00000 - xlv_COLOR0.w))) * xlv_COLOR0).xyz * _LightColor0.xyz) * ((max (0.00000, dot (xlv_TEXCOORD1, lightDir_2)) * atten_6) * 2.00000));
  c_7.w = 0.00000;
  c_1.xyz = c_7.xyz;
  c_1.w = 0.00000;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_4 = dot (xlv_TEXCOORD3, xlv_TEXCOORD3);
  lowp vec4 c_5;
  c_5.xyz = (((((texture2D (_MainTex, xlv_TEXCOORD0) * xlv_COLOR0.w) + (texture2D (_BlendTex1, xlv_TEXCOORD0) * (1.00000 - xlv_COLOR0.w))) * xlv_COLOR0).xyz * _LightColor0.xyz) * ((max (0.00000, dot (xlv_TEXCOORD1, lightDir_2)) * (texture2D (_LightTextureB0, vec2(tmpvar_4)).w * textureCube (_LightTexture0, xlv_TEXCOORD3).w)) * 2.00000));
  c_5.w = 0.00000;
  c_1.xyz = c_5.xyz;
  c_1.w = 0.00000;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lightDir_2 = xlv_TEXCOORD2;
  lowp vec4 c_3;
  c_3.xyz = (((((texture2D (_MainTex, xlv_TEXCOORD0) * xlv_COLOR0.w) + (texture2D (_BlendTex1, xlv_TEXCOORD0) * (1.00000 - xlv_COLOR0.w))) * xlv_COLOR0).xyz * _LightColor0.xyz) * ((max (0.00000, dot (xlv_TEXCOORD1, lightDir_2)) * texture2D (_LightTexture0, xlv_TEXCOORD3).w) * 2.00000));
  c_3.w = 0.00000;
  c_1.xyz = c_3.xyz;
  c_1.w = 0.00000;
  gl_FragData[0] = c_1;
