...
void main ()
{
  ...
  mediump vec4 c_13;
  c_13.xyz = ((tmpvar_3 * _LightColor0.xyz) * (dot (xlv_TEXCOORD1, lightDir_12) * 2.00000));
  c_13.w = tmpvar_4;
  c_1 = c_13;
...
void main ()
{
  ...
  atten_19 = tmpvar_12;
  mediump vec4 c_20;
  c_20.xyz = ((tmpvar_3 * _LightColor0.xyz) * ((dot (xlv_TEXCOORD1, lightDir_18) * atten_19) * 2.00000));
  c_20.w = tmpvar_4;
  c_1 = c_20;
  c_1.xyz = (c_1.xyz + (tmpvar_3 * xlv_TEXCOORD2));
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  tmpvar_12 = tmpvar_17;
  c_1.xyz = (tmpvar_3 * min ((2.00000 * texture2D (unity_Lightmap, xlv_TEXCOORD1).xyz), vec3((tmpvar_12 * 2.00000))));
  c_1.w = tmpvar_4;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  mediump vec4 c_14;
  c_14.xyz = ((tmpvar_4 * _LightColor0.xyz) * (dot (xlv_TEXCOORD1, lightDir_13) * 2.00000));
  c_14.w = tmpvar_5;
  c_1.xyz = c_14.xyz;
  c_1.w = 0.00000;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  mediump float atten_19;
  atten_19 = ((float((xlv_TEXCOORD3.z > 0.00000)) * tmpvar_14.w) * tmpvar_17.w);
  mediump vec4 c_20;
  c_20.xyz = ((tmpvar_4 * _LightColor0.xyz) * ((dot (xlv_TEXCOORD1, lightDir_18) * atten_19) * 2.00000));
  c_20.w = tmpvar_5;
  c_1.xyz = c_20.xyz;
  c_1.w = 0.00000;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  mediump vec4 c_16;
  c_16.xyz = ((tmpvar_4 * _LightColor0.xyz) * ((dot (xlv_TEXCOORD1, lightDir_14) * atten_15) * 2.00000));
  c_16.w = tmpvar_5;
  c_1.xyz = c_16.xyz;
  c_1.w = 0.00000;
  gl_FragData[0] = c_1;
